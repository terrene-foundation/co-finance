#!/usr/bin/env node
/**
 * Plugin Builder for FMI COC Claude (Python)
 *
 * Packages the setup as a distributable .claude-plugin for easy installation.
 *
 * Gap Resolution: "No Plugin Distribution" from 02-fmi-setup-gaps.md
 *
 * Usage:
...
const PLUGIN_NAME = "fmi-coc-claude-py";
...
function createManifest() {
  return {
    ...
    description:
      "Domain-specific Claude Code setup for Financial Markets & Investments (FMI) ecosystem",
    author: "FMI Team",
    license: "MIT",
    ...
    repository: {
      type: "git",
      url: "https://github.com/fmi-agents/fmi-coc-claude-py",
    },
    components: {
      agents: 25,
      skills: 18,
