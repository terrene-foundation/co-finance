...
### 1. Terrene Foundation (`~/repos/terrene/terrene`)
...
### 2. Kailash Python SDK BUILD (`~/repos/dev/kailash_python_sdk`)
...
### 3. Kailash Python USE (`~/repos/kailash/kailash-coc-claude-py`)
...
### 4. Kailash Rust BUILD/USE (`~/repos/kailash/kailash-coc-claude-rs`)
